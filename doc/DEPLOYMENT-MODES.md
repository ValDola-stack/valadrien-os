...
pnpm valadrien-os onboard --yes --bind lan
pnpm valadrien-os run --bind tailnet
```
...
For `authenticated/private`, ValadrienOs supports a browser-first setup path:

1. open the ValadrienOs URL from the private network or appliance UI
2. sign in or create a ValadrienOs account
