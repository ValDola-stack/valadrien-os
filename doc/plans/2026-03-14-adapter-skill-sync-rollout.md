...
- desired skills are stored in ValadrienOs
...
- ValadrienOs reconciles desired skills into `~/.cursor/skills`
...
- ValadrienOs reconciles desired skills into `~/.gemini/skills`
...
- ValadrienOs reconciles desired skills into `~/.pi/agent/skills`
