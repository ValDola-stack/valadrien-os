...
import { createAgentKeySchema, createBoardApiKeySchema, type Agent } from "@valadrien-os/shared";
import {
...
export function registerTokenCommands(program: Command): void {
  const token = program.command("token").description("Manage ValadrienOs API tokens");
