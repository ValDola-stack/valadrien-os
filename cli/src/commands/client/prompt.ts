...
import type { Agent, Issue, IssueComment } from "@valadrien-os/shared";
import { addIssueCommentSchema, createIssueSchema } from "@valadrien-os/shared";
import {
...
export function registerPromptCommands(program: Command): void {
  addCommonClientOptions(
    program
      ...
      .description("Create/update ValadrienOs work for an agent using an agent API key")
  ...
  addCommonClientOptions(
    agent
      .command("prompt")
      .description("Create/update ValadrienOs work using an agent persona")
      .argument("<prompt...>", "Prompt text")
  ...
  addCommonClientOptions(
    board
      .command("prompt")
      .description("Create/update ValadrienOs work for an agent using board auth")
