...
summary: What ValadrienOs experimental features mean for board operators
---
...
When a feature is marked experimental, ValadrienOs is still evaluating the product shape and implementation details.
...
- ValadrienOs does not promise compatibility, rollback, migration, or long-term support for experimental features.
