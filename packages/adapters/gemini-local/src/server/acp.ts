...
export function formatGeminiAcpFallbackMessage(reason: string): string {
  return `[valadrien-os] Gemini ACP default unavailable; falling back to Gemini CLI. ${reason} Set engine=acp to require ACP or engine=cli to silence this fallback.\n`;
}
