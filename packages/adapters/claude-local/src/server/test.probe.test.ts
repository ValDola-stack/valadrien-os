...
const {
  ...
  return {
    ...
    resolveAdapterExecutionTargetCwd: vi.fn(() => "/home/daytona/valadrien-os-workspace"),
  };
});
...
const initLine =
  '{"type":"system","subtype":"init","cwd":"/home/daytona/valadrien-os-workspace","session_id":"abc","tools":["Bash","Read"]}';
