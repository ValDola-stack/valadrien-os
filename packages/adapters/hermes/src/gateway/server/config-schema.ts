  ...
  return {
    fields: [
      ...
      },
      {
        ...
        type: "text",
        required: true,
        hint: "Hermes API_SERVER_KEY, not VALADRIEN_OS_API_KEY. Stored as a ValadrienOs secret reference.",
        meta: { secret: true },
      },
      {
      ...
      },
      {
        ...
        type: "text",
        hint: "Optional ValadrienOs API URL reachable by the remote Hermes host. This is not a credential.",
      },
      {
        key: "headers",
        label: "Extra headers",
