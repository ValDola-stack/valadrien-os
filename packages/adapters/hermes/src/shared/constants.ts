...
/** Adapter type identifier registered with ValadrienOs. */
export const ADAPTER_TYPE = "hermes_local";

/** Human-readable label shown in the ValadrienOs UI. */
 ...
 * hardcoded Anthropic model during ValadrienOs onboarding.
 */
