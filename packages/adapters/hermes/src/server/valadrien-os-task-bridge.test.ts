...
const helperPath = path.resolve(__dirname, "../../skills/valadrien-os-task-bridge/valadrien-os-task.mjs");
...
describe("valadrien-os-task-bridge helper", () => {
  ...
  function env() {
    return {
      VALADRIEN_OS_API_URL: baseUrl,
      VALADRIEN_OS_BRIDGE_API_KEY: apiKey,
      VALADRIEN_OS_COMPANY_ID: "22222222-2222-4222-8222-222222222222",
      VALADRIEN_OS_AGENT_ID: "11111111-1111-4111-8111-111111111111",
      VALADRIEN_OS_RUN_ID: "66666666-6666-4666-8666-666666666666",
    };
  }
  ...
  it("creates tasks assigned to the authenticated agent by default", async () => {
    ...
    expect(createRequest?.headers["x-valadrien-os-run-id"]).toBe("66666666-6666-4666-8666-666666666666");
