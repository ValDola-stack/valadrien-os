  ...
  return {
    fields: [
      ...
      },
      {
        ...
        type: "toggle",
        default: true,
        hint: "Resume Hermes sessions across ValadrienOs heartbeats.",
      },
      {
        key: "worktreeMode",
      ...
      },
      {
        ...
        type: "toggle",
        default: true,
        hint: "Pass Hermes --quiet for cleaner ValadrienOs run transcripts.",
      },
      {
        key: "verbose",
      ...
      {
        key: "valadrienOsApiUrl",
        label: "ValadrienOs API URL",
        type: "text",
        hint: "Optional API base override. Defaults to VALADRIEN_OS_API_URL.",
      },
      {
        key: "promptTemplate",
