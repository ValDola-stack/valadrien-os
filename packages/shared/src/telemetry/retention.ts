 ...
 *
 * Defines the retention class for each ValadrienOs telemetry event and the
 ...
 * that are not part of the shared generated `ValadrienOsEventName` type. When an
 ...
 *   External-system event (Codex CLI) — not yet in ValadrienOsEventName.
