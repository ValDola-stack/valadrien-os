...
import * as generatedTelemetry from "./generated/valadrien-os-telemetry.js";
...
describe("telemetry README contract", () => {
  it("documents generated event helper exports that exist", () => {
    ...
    expect(readme).not.toContain("createValadrienOsTelemetryEvent");
    expect(readme).not.toContain("createValadrienOsTelemetryEnvelope");
  });
});
