...
export interface ValadrienOsAgentCreatedDimensions {
agent_id: string
agent_role: ("ceo" | "cto" | "cmo" | "cfo" | "security" | "engineer" | "designer" | "pm" | "qa" | "devops" | "researcher" | "general" | "other")
}

export interface ValadrienOsAgentFirstHeartbeatDimensions {
agent_id: string
agent_role: ("ceo" | "cto" | "cmo" | "cfo" | "security" | "engineer" | "designer" | "pm" | "qa" | "devops" | "researcher" | "general" | "other")
}

export interface ValadrienOsAgentTaskCompletedDimensions {
...
export interface ValadrienOsCompanyImportedDimensions {
source_type: ("local_path" | "github" | "url" | "catalog" | "skills_sh" | "unknown")
source_ref?: string
source_ref_hashed?: boolean
}

export interface ValadrienOsErrorHandlerCrashDimensions {
error_code: string
}

export interface ValadrienOsGoalCreatedDimensions {
goal_level: ("company" | "team" | "agent" | "task" | "other")
}

export interface ValadrienOsInstallCompletedDimensions {
adapter_type: ("process" | "http" | "acpx_local" | "claude_local" | "codex_local" | "cursor_cloud" | "gemini_local" | "hermes_gateway" | "hermes_local" | "opencode_local" | "pi_local" | "cursor" | "openclaw_gateway" | "grok_local" | "other")
}

export interface ValadrienOsInstallStartedDimensions {

}

export interface ValadrienOsInteractionResolvedDimensions {
...
export interface ValadrienOsProjectCreatedDimensions {

}

export interface ValadrienOsRoutineCreatedDimensions {

}

export interface ValadrienOsRoutineRunDimensions {
source: ("schedule" | "manual" | "api" | "webhook" | "other")
status: ("received" | "coalesced" | "skipped" | "issue_created" | "completed" | "failed" | "other")
}

export interface ValadrienOsSkillImportedDimensions {
source_type: ("local_path" | "github" | "url" | "catalog" | "skills_sh" | "unknown")
skill_ref?: string
}

export type ValadrienOsEventName =
  | "agent.created"
...
export interface EventDimensionsMap {
  "agent.created": ValadrienOsAgentCreatedDimensions;
  "agent.first_heartbeat": ValadrienOsAgentFirstHeartbeatDimensions;
  "agent.task_completed": ValadrienOsAgentTaskCompletedDimensions;
  "company.imported": ValadrienOsCompanyImportedDimensions;
  "error.handler_crash": ValadrienOsErrorHandlerCrashDimensions;
  "goal.created": ValadrienOsGoalCreatedDimensions;
  "install.completed": ValadrienOsInstallCompletedDimensions;
  "install.started": ValadrienOsInstallStartedDimensions;
  "interaction.resolved": ValadrienOsInteractionResolvedDimensions;
  "project.created": ValadrienOsProjectCreatedDimensions;
  "routine.created": ValadrienOsRoutineCreatedDimensions;
  "routine.run": ValadrienOsRoutineRunDimensions;
  "skill.imported": ValadrienOsSkillImportedDimensions;
}

export const VALADRIEN_OS_EVENTS = {
...
export const VALADRIEN_OS_ENUM_DESCRIPTIONS = {
  "agent.created": {
    "agent_role": {
  ...
  "company.imported": {
    "source_type": {
      ...
      "catalog": "Import source came from a ValadrienOs catalog entry.",
  ...
  "interaction.resolved": {
    ...
    "resolved_by_kind": {
      ...
      "system": "ValadrienOs resolved the interaction automatically.",
...
export interface ValadrienOsTelemetryEvent<K extends ValadrienOsEventName = ValadrienOsEventName> {
name: K
occurredAt: string
dimensions: EventDimensionsMap[K]
}

export type AnyValadrienOsTelemetryEvent = {
  [K in ValadrienOsEventName]: ValadrienOsTelemetryEvent<K>
}[ValadrienOsEventName];

export interface ValadrienOsTelemetryBatch {
app: "valadrien-os"
schemaVersion: typeof SCHEMA_VERSION
installId: string
version?: string
events: AnyValadrienOsTelemetryEvent[]
}

export function makeEvent<K extends ValadrienOsEventName>(
  name: K,
  dimensions: EventDimensionsMap[K],
  occurredAt: string
): ValadrienOsTelemetryEvent<K> {
  return { name, occurredAt, dimensions };
}

export function makeBatch(
  installId: string,
  events: readonly AnyValadrienOsTelemetryEvent[],
  version?: string
): ValadrienOsTelemetryBatch {
  return {
    app: "valadrien-os",
