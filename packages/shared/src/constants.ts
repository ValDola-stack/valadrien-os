...
// Config keys owned by ValadrienOs/company state rather than one concrete adapter.
// `valadrienOsSkillSync` is persisted in adapterConfig but must survive adapter swaps.
