...
const TAIL_MARKER_STDOUT = "__VALADRIEN_OS_RUN_LOG_STDOUT__";
const TAIL_MARKER_STDERR = "__VALADRIEN_OS_RUN_LOG_STDERR__";
const TAIL_MARKER_END = "__VALADRIEN_OS_RUN_LOG_END__";
