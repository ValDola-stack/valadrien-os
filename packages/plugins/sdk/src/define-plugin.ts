...
export interface PluginDefinition {
  ...
  /**
   * Called when ValadrienOs scans issue/comment/document content and asks this
  ...
  /**
   * Called when ValadrienOs needs the current normalized status for one external
