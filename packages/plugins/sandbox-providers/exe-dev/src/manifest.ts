      ...
      configSchema: {
        ...
        properties: {
          ...
          apiKey: {
            ...
            format: "secret-ref",
            description:
              "Paste your exe.dev API token, or pick a saved ValadrienOs secret. Create one at exe.dev → Settings → API tokens with `/exec` scope (`new`, `ls`, `rm`).",
          },
          sshPrivateKey: {
            type: "string",
            format: "secret-ref",
          ...
          sshUser: {
            ...
            "x-valadrien-os-advanced": true,
            "x-valadrien-os-group": "SSH access",
          },
          sshIdentityFile: {
            type: "string",
            description:
              "Absolute path to a private key on the ValadrienOs host. Used only when SSH Private Key is empty.",
            "x-valadrien-os-advanced": true,
            "x-valadrien-os-group": "SSH access",
          },
          sshPort: {
          ...
          image: {
            ...
            "x-valadrien-os-advanced": true,
            "x-valadrien-os-group": "VM resources",
          },
          cpu: {
            type: "number",
          ...
          command: {
            ...
            "x-valadrien-os-advanced": true,
            "x-valadrien-os-group": "VM creation",
          },
          env: {
            type: "object",
          ...
          apiUrl: {
            ...
            "x-valadrien-os-advanced": true,
            "x-valadrien-os-group": "API + runtime",
          },
          timeoutMs: {
            type: "number",
