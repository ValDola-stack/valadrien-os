 ...
 * which valadrien-os-server can exec arbitrary commands. This solves the
 ...
 *
 * NOTE: valadrien-os-server runs OUTSIDE the cluster, so we cannot set ownerReferences
...
export function buildSandboxCrManifest(
  ...
  return {
    ...
    metadata: {
      ...
      labels: { ...input.labels },
      // No ownerReferences: valadrien-os-server is out-of-cluster. Release is
      // explicit delete.
    },
    spec: {
      podTemplate: {
        ...
        spec: {
          ...
          // Agent containers call back to valadrien-os-server via HTTPS egress;
          ...
          containers: [
            {
              ...
              // sleep infinity keeps the pod running; valadrien-os-server execs
              ...
              env: [{ name: "HOME", value: "/home/valadrien-os" }],
              ...
              volumeMounts: [
                ...
                { name: "home", mountPath: "/home/valadrien-os" },
                { name: "cache", mountPath: "/home/valadrien-os/.cache" },
