 ...
 *
 * The Sandbox CR creates a long-lived pod that valadrien-os-server can exec into
 ...
 * Fallback: list pods in the namespace filtered by the valadrien-os.io/managed-by
