...
// Namespace names are capped at 63 chars (RFC 1123). The default "valadrien-os-"
...
export function valadrienOsLabels(input: LabelsInput): Record<string, string> {
  return {
    "valadrien-os.io/run-id": input.runId,
    "valadrien-os.io/agent-id": input.agentId,
    "valadrien-os.io/company-id": input.companyId,
    "valadrien-os.io/adapter": input.adapterType,
