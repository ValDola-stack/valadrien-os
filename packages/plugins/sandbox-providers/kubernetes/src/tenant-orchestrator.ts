...
const SERVICE_ACCOUNT_NAME = "valadrien-os-tenant-sa";
const ROLE_NAME = "valadrien-os-tenant-role";
const ROLE_BINDING_NAME = "valadrien-os-tenant-rb";
const RESOURCE_QUOTA_NAME = "valadrien-os-quota";
const LIMIT_RANGE_NAME = "valadrien-os-limits";
 ...
 * old valadrien-os-egress-allow NetworkPolicy in place alongside the new
    ...
    clients.core.createNamespace({
        body: {
          ...
          metadata: {
            ...
            labels: {
              "valadrien-os.io/company-id": input.companyId,
              "valadrien-os.io/managed-by": "valadrien-os-k8s-plugin",
...
async function ensureNetworkPolicies(clients: KubeClients, input: EnsureTenantInput): Promise<void> {
  const [denyAll, egressStd] = buildNetworkPolicyManifests({
    namespace: input.namespace,
    valadrienOsServerNamespace: input.valadrienOsServerNamespace,
