 ...
 *        docker tag alpine:3.20 localhost/valadrien-os-agent:latest
 *        kind load docker-image localhost/valadrien-os-agent:latest --name valadrien-os
 ...
 *      And a tini-bearing image pre-loaded (e.g. the same localhost/valadrien-os-agent:latest
 ...
 * ("valadrien-os-"), resolving to "valadrien-os-spike-e2e".
 */
...
const NAMESPACE = "valadrien-os-spike-e2e";
...
describe("plugin-kubernetes end-to-end", () => {
  ...
  it.runIf(process.env.RUN_K8S_INTEGRATION_TESTS === "1")(
    ...
    async () => {
      ...
      expect(all).toContain("serviceaccount/valadrien-os-tenant-sa");
      expect(all).toContain("role.rbac.authorization.k8s.io/valadrien-os-tenant-role");
      expect(all).toContain("rolebinding.rbac.authorization.k8s.io/valadrien-os-tenant-rb");
      expect(all).toContain("resourcequota/valadrien-os-quota");
      expect(all).toContain("limitrange/valadrien-os-limits");
      expect(all).toContain("networkpolicy.networking.k8s.io/valadrien-os-deny-all");
      expect(all).toContain("networkpolicy.networking.k8s.io/valadrien-os-egress-allow");
