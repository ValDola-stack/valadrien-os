...
Use this reference when generating or reviewing deterministic ValadrienOs capsule identicons/profile pills. Prototype source paths, when the ValadrienOs content repository is available:

- `valadrien-os-content/design/PAP-11825/valadrien-os-capsule-identicon-prototyper/README.md`
- `valadrien-os-content/design/PAP-11825/valadrien-os-capsule-identicon-prototyper/src/identicon.ts`
- `valadrien-os-content/design/PAP-11825/valadrien-os-capsule-identicon-prototyper/src/App.tsx`
...
- Seed: `valadrien-os capsule bank`
