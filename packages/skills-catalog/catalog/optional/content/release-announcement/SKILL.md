...
## ValadrienOs Cases output

When this skill runs inside ValadrienOs and `experimental.enableCases` is enabled,
...
Use `skills/valadrien-os/references/cases.md` for the API contract. Include
`X-ValadrienOs-Run-Id` on writes when `VALADRIEN_OS_RUN_ID` is set. If the API returns
...
{
  "caseType": "blog_post",
  "key": "valadrien-os-release:vYYYY.MDD.P:blog-post",
  "title": "ValadrienOs vYYYY.MDD.P launch post",
  "status": "in_review",
  "parentCaseId": "<release-case-id>",
  "fields": {
    "schema_version": 1,
    "version": "vYYYY.MDD.P",
    "slug": "valadrien-os-vYYYY-MDD-P",
...
```json
{
  ...
  "key": "valadrien-os-release:vYYYY.MDD.P:tweet-storm",
  "title": "ValadrienOs vYYYY.MDD.P tweet storm",
  "status": "in_review",
  "parentCaseId": "<release-case-id>",
  "fields": {
    "schema_version": 1,
