---
name: Core Exec Team
description: Default leadership and engineering team for bootstrapping a ValadrienOs company with a CEO, CTO, QA Engineer, starter project, and a recurring CEO heartbeat review task.
...
tags:
  ...
  - qa
requiredSkills:
  - paperclipai/bundled/valadrien-os-operations/task-planning
  - paperclipai/bundled/valadrien-os-operations/issue-triage
...
The Core Exec Team is the bundled default install for a new ValadrienOs company. It boots the smallest org that can take a board prompt, plan it, implement it, and verify it.
