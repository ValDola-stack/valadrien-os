...
import type { Agent, AgentInstructionsBundle, AgentInstructionsFileDetail, AgentInstructionsFileSummary } from "@valadrien-os/shared";
...
function makeBundle(
  ...
  return {
    ...
    companyId: "company-1",
    mode: "managed",
    rootPath: "/valadrien-os/agents/agent-1/instructions",
    managedRootPath: "/valadrien-os/agents/agent-1/instructions",
    entryFile,
    resolvedEntryPath: `/valadrien-os/agents/agent-1/instructions/${entryFile}`,
    editable: true,
    warnings: [],
