...
function classifySource(skill: {
  ...
  if (skill.sourceBadge === "valadrien-os") return "company";
...
function CompatChip({ compatibility }: { compatibility: CompanySkillCompatibility }) {
  ...
  const map = {
    unknown: {
      ...
      tooltip: "ValadrienOs could not validate this skill as Agent Skills markdown. Install at your own risk.",
...
function buildDiscoveryCards(
  ...
  for (const entry of catalog) {
    ...
    cards.push({
      ...
      name: entry.name,
      slug: entry.slug,
      author: entry.packageName ?? "ValadrienOs",
...
export function CompanySkills() {
  ...
  const studioDescription = studioForkFromId
    ...
    : "Create an editable company skill in the ValadrienOs workspace.";
