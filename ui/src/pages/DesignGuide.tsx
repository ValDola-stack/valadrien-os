...
export function DesignGuide() {
  ...
  return (
    <div className="space-y-10 max-w-4xl">
      ...
      {/*  AGENT CAPSULE                                                */}
      {/* ============================================================ */}
      {/* SYNC-TODO: dropped fork "Agent System (GLASSHOUSE)" showcase (AgentPortrait/AgentFace/HeartbeatSpine demos) in favor of upstream Agent Capsule section */}
      ...
      <Section title="Inline Banner">
        ...
        <div className="space-y-3">
          ...
          >
            Ships with ValadrienOs and powers <strong>Briefs</strong>. It can be paused but not deleted.
          </InlineBanner>
          <InlineBanner
            tone="warning"
