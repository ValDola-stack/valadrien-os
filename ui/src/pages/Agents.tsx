...
import { AGENT_ROLE_LABELS, type Agent, type Environment, type EnvironmentCapabilities } from "@valadrien-os/shared";
import {
  isStarred,
...
const localEnvironmentDescriptor: EnvironmentDescriptor = {
  label: "Local",
  detail: "ValadrienOs host",
  title: "Local - ValadrienOs host",
};
