          ...
          <div className="min-w-0 space-y-1">
            ...
            <div className="text-xs text-muted-foreground">
              ...
              <span
                ...
                title={templateRef
                  ? `Provider ${activeTemplate.templateKind} ref ${templateRef} (ValadrienOs template ${activeTemplate.id})`
                  : activeTemplate.id}
              >
        ...
        <div className="rounded-md border border-border bg-background" data-testid="environment-form-page">
          <div className="border-b border-border/60 px-6 pb-4 pt-6">
            ...
            <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
              Configure a reusable execution target for your agents. Saved changes affect future runs; ValadrienOs may start fresh sessions or sandbox leases after environment config changes.
            </p>
          </div>
