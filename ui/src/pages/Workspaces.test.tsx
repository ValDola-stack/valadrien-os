...
import type { WorkspaceOverviewItem, WorkspaceOverviewResponse } from "@valadrien-os/shared";
...
function overviewItem(overrides: Partial<WorkspaceOverviewItem> = {}): WorkspaceOverviewItem {
  return {
    ...
    projectUrlKey: overrides.projectUrlKey ?? "valadrien-os-app",
    projectName: overrides.projectName ?? "ValadrienOs App",
...
describe("Workspaces", () => {
  ...
  it("uses the bounded overview endpoint and renders grouped workspace cards with linked task summaries", async () => {
    ...
    expect(container.querySelector('a[href="/projects/valadrien-os-app/workspaces"]')).not.toBeNull();
