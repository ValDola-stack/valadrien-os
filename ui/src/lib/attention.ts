...
export const ATTENTION_GROUP_BY_KEY = "valadrien-os:attention:group-by";
export const ATTENTION_SORT_KEY = "valadrien-os:attention:sort";
export const ATTENTION_FILTERS_KEY_PREFIX = "valadrien-os:attention:filters";
export const ATTENTION_COLLAPSED_GROUPS_KEY_PREFIX = "valadrien-os:attention:collapsed-groups";
