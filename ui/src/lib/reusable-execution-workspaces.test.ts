...
describe("buildReusableExecutionWorkspaceOptionGroups", () => {
  ...
  it("builds stable display and search metadata", () => {
    ...
    expect(option.label).toBe("ValadrienOs app");
    expect(option.description).toBe("feature/workspaces");
    expect(option.searchText).toBe("ValadrienOs app active feature/workspaces /repo/valadrien-os workspace-1");
  });
  ...
  it("does not match query letters spread across unrelated workspace text", () => {
    const groups = buildReusableExecutionWorkspaceOptionGroups([
      workspace({
        ...
        cwd: "/srv/valadrien-os/home/paperclipai/paperclip/.valadrien-os/worktrees/PAP-11694-editing-routine-bodies",
      ...
      workspace({
        ...
        cwd: "/srv/valadrien-os/home/paperclipai/paperclip/.valadrien-os/worktrees/PAP-11446-on-mobile-agent-chat",
      ...
      workspace({
        ...
        cwd: "/srv/valadrien-os/home/paperclipai/paperclip/.valadrien-os/worktrees/PAP-11429-live-simultaneously",
  ...
  it("scores visible label matches ahead of hidden path matches", () => {
    const groups = buildReusableExecutionWorkspaceOptionGroups([
      workspace({
        id: "path-only-mobile",
        name: "ValadrienOs app",
        cwd: "/srv/valadrien-os/mobile-checkout",
      ...
      workspace({
        ...
        cwd: "/srv/valadrien-os/agent-chat",
