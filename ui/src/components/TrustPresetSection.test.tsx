...
import type { AgentPermissions } from "@valadrien-os/shared";
    ...
    createdRoot.render(
      <TooltipProvider>
        <TrustPresetSection
          ...
          onChange={onChange}
          companyId="company-1"
          projectCandidates={[{ id: "project-1", label: "ValadrienOs App" }]}
...
describe("TrustPresetSection", () => {
  it("hides the CE boundary editor under Standard", () => {
    ...
    expect(view.text()).not.toContain("Get ValadrienOs EE.");
  });
  ...
  it("shows a selectable CE boundary editor for low-trust review", () => {
    ...
    expect(view.text()).toContain("ValadrienOs App");
    expect(view.text()).toContain("Get ValadrienOs EE.");
