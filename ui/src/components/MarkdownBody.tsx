...
function MarkdownIssueLink({
  ...
  return (
    <Link
      ...
      className={cn("valadrien-os-markdown-issue-ref", "font-normal underline")}
      title={title}
...
function MarkdownCaseLink({
  ...
  return (
    <Link
      ...
      className={cn("valadrien-os-markdown-case-ref", "font-normal underline")}
...
function MarkdownExternalLink({
  ...
  return (
    <a
      ...
      className="valadrien-os-markdown-external-ref"
    >
