...
describe("accent markdown styles", () => {
  it("inherits the current message bubble foreground for prose text, links, and list counters", () => {
    const block = cssBlock(".valadrien-os-markdown.valadrien-os-markdown-on-accent");
  ...
  it("keeps ordered-list markers and rendered link variants readable on accent bubbles", () => {
    expect(cssBlock(".valadrien-os-markdown.valadrien-os-markdown-on-accent li::marker")).toContain(
      "color: currentColor",
    );
    expect(cssBlock(".valadrien-os-markdown.valadrien-os-markdown-on-accent :where(a, a:visited)")).toContain(
      "color: currentColor",
    );
    expect(cssBlock(".valadrien-os-markdown.valadrien-os-markdown-on-accent .valadrien-os-workspace-file-link")).toContain(
      "color: currentColor",
    );
    expect(
      cssBlock(
        ".valadrien-os-markdown.valadrien-os-markdown-on-accent :where(a.valadrien-os-mention-chip, a.valadrien-os-project-mention-chip)",
      ),
