...
import type { WorkspaceFileRef } from "@valadrien-os/shared";
...
export function ArtifactFileChip({
  ...
  const classNames = cn(
    "valadrien-os-artifact-file-chip inline-flex items-center gap-1 rounded-sm border border-border bg-muted/60 px-1.5 py-0.5 font-mono text-xs leading-tight text-foreground/90 align-middle no-underline hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1",
