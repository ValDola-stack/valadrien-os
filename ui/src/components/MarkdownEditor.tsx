  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative valadrien-os-mdxeditor-scope",
    ...
    >
      <MarkdownEditorRichErrorBoundary onError={handleRichEditorError}>
        <MDXEditor
          ...
          className={cn("valadrien-os-mdxeditor", !bordered && "valadrien-os-mdxeditor--borderless")}
          contentEditableClassName={cn(
            "valadrien-os-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
            contentClassName,
          )}
