...
import type { AgentPermissions, TrustPreset } from "@valadrien-os/shared";
  ...
  return (
    <div>
      ...
      <div className="rounded-lg border border-border p-4 space-y-3">
        <Field label="Trust preset" hint="Choose how broadly this agent can read and act on ValadrienOs work objects.">
          <select
            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                <a
                  ...
                  href="https://valadrien-os.ing/ee"
                  target="_blank"
                  rel="noreferrer"
                >
                  Get ValadrienOs EE.
