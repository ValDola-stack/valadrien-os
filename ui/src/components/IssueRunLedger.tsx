...
import type { ActivityEvent, Issue, Agent } from "@valadrien-os/shared";
import { isResponsibleUserDenialCode, responsibleUserLabel } from "@valadrien-os/shared";
...
function watchdogDecisionErrorMessage(error: unknown) {
  ...
  return error instanceof Error && error.message.trim().length > 0
    ? error.message
    : "ValadrienOs could not record the watchdog decision.";
}
