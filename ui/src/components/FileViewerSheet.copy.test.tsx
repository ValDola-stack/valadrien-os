...
import type { ResolvedWorkspaceResource, WorkspaceFileContent } from "@valadrien-os/shared";
...
describe("FileViewerSheet copy actions", () => {
  ...
  beforeEach(() => {
    ...
    window.history.pushState({}, "", "/PAP/issues/PAP-10629?file=videos%2F90-days-valadrien-os%2Ftweet.md");
  });
    ...
    flushSync(() => {
      root.render(
        <FileViewerSheet
          issueId="issue-1"
          state={{
            path: "videos/90-days-valadrien-os/tweet.md",
            workspace: "auto",
            line: null,
            column: null,
            projectId: null,
