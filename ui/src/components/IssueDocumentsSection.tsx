...
import { isSystemIssueDocumentKey } from "@valadrien-os/shared";
...
const getFoldedDocumentsStorageKey = (issueId: string) => `valadrien-os:issue-document-folds:${issueId}`;
...
export function IssueDocumentsSection({
  ...
  const documentBodyContentClassName = "valadrien-os-edit-in-place-content min-h-(--sz-220px) text-sm leading-7";
