...
describe("SidebarAccountMenu", () => {
  ...
  it("renders the signed-in user and opens the account card menu", async () => {
    ...
    const feedbackAnchor = document.body.querySelector('a[href="https://valadrien-os.ing/feedback"]') as HTMLAnchorElement | null;
    ...
    expect(document.body.textContent).toContain("ValadrienOs v1.2.3");
