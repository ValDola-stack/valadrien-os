        ...
        options: [
          {
            key: "all:path-only",
            value: "path-only",
            label: "ValadrienOs app",
            searchText: "/srv/valadrien-os/mobile-checkout",
          },
          {
            key: "all:mobile",
            value: "mobile",
            label: "Mobile agent chat",
            searchText: "/srv/valadrien-os/agent-chat",
          },
        ],
      },
    ];
  ...
  it("filters workspace options, moves with arrows, and selects the workspace id with Enter", async () => {
    ...
    const groups = buildWorkspaceSelectGroups([
      ...
      workspace({
        ...
        name: "Marketing site",
        cwd: "/srv/valadrien-os/home/marketing-site",
    ...
    expect(container.textContent).toContain("ValadrienOs app");
    ...
    expect(selectedOptionKey()).toBe("recent:workspace-valadrien-os");
    keyDown(input!, "ArrowDown");
    await flush();
    expect(selectedOptionKey()).toBe("all:workspace-valadrien-os");
    ...
    expect(onValueChange).toHaveBeenCalledWith(
      "workspace-valadrien-os",
      expect.objectContaining({
        key: "all:workspace-valadrien-os",
        value: "workspace-valadrien-os",
        workspaceId: "workspace-valadrien-os",
      }),
    );
