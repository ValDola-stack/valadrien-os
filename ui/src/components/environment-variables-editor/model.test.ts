...
import type { CompanySecret, UserSecretDefinition } from "@valadrien-os/shared";
import {
...
describe("validateName", () => {
  ...
  it("flags reserved prefixes as warnings", () => {
    const issue = validateName("VALADRIEN_OS_HOME", new Set(), reserved);
