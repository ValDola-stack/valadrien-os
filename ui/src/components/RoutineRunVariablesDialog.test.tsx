...
import type { Agent, ExecutionWorkspace, Project, RoutineVariable } from "@valadrien-os/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/valadrien-os/project-1",
      effectiveLocalFolder: "/tmp/valadrien-os/project-1",
