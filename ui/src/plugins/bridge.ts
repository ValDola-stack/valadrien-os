 ...
 * `useHostContext` from `@valadrien-os/plugin-sdk/ui`.  Those are type-only
 ...
 * registry on `globalThis.__valadrienOsPluginBridge__`), context propagation
...
/**
 * Resolve a plugin-provided ValadrienOs path to the active company scope.
 *
