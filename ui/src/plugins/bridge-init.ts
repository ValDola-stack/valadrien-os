 ...
 *
 * This is placed on `globalThis.__valadrienOsPluginBridge__` and consumed by
...
declare global {
  ...
  var __valadrienOsPluginBridge__: PluginBridgeRegistry | undefined;
}
...
function PluginSdkIssuesList({
  ...
  projectId = null,
  filters,
  viewStateKey = "valadrien-os:plugin-issues-view",
  initialSearch,
  createIssueLabel,
 ...
 * on `globalThis.__valadrienOsPluginBridge__` so the plugin module loader
