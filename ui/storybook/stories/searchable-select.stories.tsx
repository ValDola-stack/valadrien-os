...
const WORKSPACES: ReusableExecutionWorkspaceLike[] = [
  {
    ...
    cwd: "/srv/valadrien-os/home/paperclipai/paperclip/.valadrien-os/worktrees/PAP-11502-auth-token-refresh",
  ...
  },
  {
    ...
    cwd: "/srv/valadrien-os/home/paperclipai/paperclip/.valadrien-os/worktrees/PAP-11380-billing-webhooks",
  ...
  },
  {
    ...
    cwd: "/srv/valadrien-os/home/paperclipai/paperclip/.valadrien-os/worktrees/PAP-11722-new-existing-workspace-selector",
  ...
  },
  {
    ...
    cwd: "/srv/valadrien-os/home/docs/.valadrien-os/worktrees/docs-trust-presets",
  ...
  },
  {
    ...
    cwd: "/srv/valadrien-os/home/paperclipai/paperclip/.valadrien-os/worktrees/PAP-11567-body-document-ui",
  ...
  },
  {
    id: "ws-watchdog",
    name: "task-watchdog",
    cwd: "/srv/valadrien-os/home/paperclipai/paperclip/.valadrien-os/worktrees/PAP-11275-task-watchdog",
...
const LONG_WORKSPACES: ReusableExecutionWorkspaceLike[] = [
  {
    id: "ws-long-name",
    name: "valadrien-os-control-plane-existing-workspace-selector-long-running-validation-branch",
    cwd: "/srv/valadrien-os/home/paperclipai/paperclip/.valadrien-os/worktrees/PAP-11722-existing-workspace-selector-with-a-very-long-path-segment-for-review",
  ...
  },
  {
    ...
    cwd: "/srv/valadrien-os/home/paperclipai/paperclip/packages/adapters/external-plugin-fixtures/hermes-droid-regression-workspace-with-long-directory-name",
    branchName: null,
    status: "idle",
    lastUsedAt: new Date(NOW.getTime() - 1 * DAY),
  },
