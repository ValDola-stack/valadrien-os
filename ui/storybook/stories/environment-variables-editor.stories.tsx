...
import type { CompanySecret, EnvBinding, SecretStatus } from "@valadrien-os/shared";
...
const SECRETS: CompanySecret[] = [
  ...
  secret("s-resend-long", "/valadrien-os-cloud/prod/provider/resend/api-key-with-a-very-long-name", { latestVersion: 4 }),
    ...
    <Surface title="Validation & health" hint="Invalid charset + reserved prefix warn on load; missing + disabled secret bindings drive the “2 bindings need attention” summary. Add a duplicate name to see the duplicate flag.">
      <Editor
        initial={{
          ...
          VALADRIEN_OS_TOKEN: { type: "plain", value: "override" },
