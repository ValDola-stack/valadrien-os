...
import { storybookAgents, storybookProjects, storybookIssues } from "../fixtures/valadrienOsData";
    ...
    <div className="valadrien-os-story">
      <main className="valadrien-os-story__inner max-w-[1320px] space-y-6">
        <section className="valadrien-os-story__frame p-6">
          <div className="valadrien-os-story__label">Search</div>
        ...
        <section className="valadrien-os-story__frame overflow-hidden">
          <div className="valadrien-os-story__title-block">
            <div className="valadrien-os-story__label">/search</div>
        ...
        <section className="valadrien-os-story__frame overflow-hidden">
          <div className="valadrien-os-story__title-block">
            <div className="valadrien-os-story__label">/search · screen 3</div>
        ...
        <section className="valadrien-os-story__frame overflow-hidden">
          <div className="valadrien-os-story__title-block">
            <div className="valadrien-os-story__label">/search · screen 1</div>
        ...
        <section className="valadrien-os-story__frame overflow-hidden">
          <div className="valadrien-os-story__title-block">
            <div className="valadrien-os-story__label">/search · screen 4</div>
        ...
        <section className="valadrien-os-story__frame overflow-hidden p-4">
          <div className="valadrien-os-story__title-block">
            <div className="valadrien-os-story__label">Match-source chips</div>
        ...
        <section className="valadrien-os-story__frame overflow-hidden p-4">
          <div className="valadrien-os-story__title-block">
            <div className="valadrien-os-story__label">Cmd+K palette</div>
        ...
        <section className="valadrien-os-story__frame overflow-hidden p-4">
          <div className="valadrien-os-story__title-block">
            <div className="valadrien-os-story__label">Search result row</div>
