...
const MOCK_CARDS: DiscoveryCard[] = [
  {
    key: "paperclipai/paperclip/valadrien-os-dev",
    skillId: "s-dev",
    catalogRef: null,
    name: "valadrien-os-dev",
    slug: "valadrien-os-dev",
    author: "ValadrienOs",
    version: "v2.4.1",
    tagline: "Run and repair local ValadrienOs workspaces.",
    description: "Develop and operate a local ValadrienOs instance.",
