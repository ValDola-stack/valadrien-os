...
import type { Agent, FeedbackVote, IssueComment } from "@valadrien-os/shared";
...
import { storybookAgentMap, storybookAgents } from "../fixtures/valadrienOsData";
...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic ValadrienOs work: checkout, comments, linked runs, and review feedback.\n\nFlaky CI lives in https://github.com/acme/web/pull/242 — re-running. Plain control link: https://random.example.com/path stays undecorated.",
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_420px]">
        ...
        <div className="space-y-5">
          ...
          <ScenarioCard
            ...
            description="Issue is in planning mode. The composer turns amber and surfaces a Planning chip next to the valadrien-os — clicking it stages a Standard submission without immediately changing the issue mode."
          >
            <IssueChatThread
              comments={[]}
              timelineEvents={[]}
...
function IssueThreadNoticeReview() {
  return (
    <div className="valadrien-os-story">
      <main className="valadrien-os-story__inner max-w-4xl">
    ...
    <div className="valadrien-os-story">
      <main className="valadrien-os-story__inner space-y-6">
        <section className="valadrien-os-story__frame p-6">
          <div className="valadrien-os-story__label">Chat & Comments</div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use ValadrienOs operational content with mixed authors, system timeline events,
