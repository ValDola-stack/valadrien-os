...
import { storybookAgents, storybookIssues } from "../fixtures/valadrienOsData";
...
const agentManagementAgents: Agent[] = [
  agentWith({
    ...
    adapterConfig: {
      ...
      env: {
        ...
        VALADRIEN_OS_TRACE: { type: "plain", value: "storybook" },
  ...
  agentWith({
    ...
    adapterConfig: {
      ...
      payloadTemplateJson: JSON.stringify({ channel: "valadrien-os-storybook", priority: "normal" }, null, 2),
      env: {
        ...
        <main className="valadrien-os-story__inner space-y-6">
          <section className="valadrien-os-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="valadrien-os-story__label">Agent management</div>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Agent management stories cover detail, configuration, icon, action, live-run, and config primitive states using extended ValadrienOs fixtures.",
      },
    },
  },
...
const managedKubernetesEnvironment: Environment = {
  ...
  envVars: {},
  metadata: { managedByValadrienOs: true, managedKubernetesSandbox: true },
...
function ForcedKubernetesFixtures({
  ...
  // the managed Kubernetes sandbox (VALADRIEN_OS_EXECUTION_MODE=kubernetes).
