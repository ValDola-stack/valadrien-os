...
function registerResolvedVarToken(varName, fallbackRaw, sourceNote) {
  // varName like "--valadrien-os-code-highlight-bg" -> token name
  // "code-highlight-bg-resolved" (strip the leading "--valadrien-os-" prefix
  ...
  const bare = varName.replace(/^--valadrien-os-/, "").replace(/^--/, "");
