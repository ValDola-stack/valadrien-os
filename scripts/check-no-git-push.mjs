 ...
 *
 * Opt-in mechanism: a line containing `valadrien-os:allow-git-push` (typically
 * inside a `// valadrien-os:allow-git-push: <reason>` comment on the line itself
...
export const ALLOW_MARKER = "valadrien-os:allow-git-push";
