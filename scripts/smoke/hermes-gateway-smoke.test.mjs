...
VALADRIEN_OS_API_KEY="valadrien-os-secret"
VALADRIEN_OS_AUTH_HEADER="Bearer board-secret"
VALADRIEN_OS_COOKIE="session=board-cookie"
output="$(redact_text "gateway-secret claim-secret agent-secret valadrien-os-secret Bearer board-secret session=board-cookie")"
[[ "$output" != *"gateway-secret"* ]]
[[ "$output" != *"claim-secret"* ]]
[[ "$output" != *"agent-secret"* ]]
[[ "$output" != *"valadrien-os-secret"* ]]
[[ "$output" != *"board-secret"* ]]
[[ "$output" != *"board-cookie"* ]]
