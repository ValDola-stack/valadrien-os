      ...
      messages: [
        {
          role: "user",
          content:
            "Write today's operating digest for this company as clean Markdown. Use `##` section headings, `-` bullets, and `**bold**` for emphasis. Cover: spend vs budget, agent roster health, and task flow (active vs blocked). Call out anything that needs a human decision. Keep it tight — no preamble, start with the first heading.",
        },
      ],
    });
