 ...
 * toggle server-side adapter code for the whole ValadrienOs instance.
 *
...
interface AdapterInstallRequest {
  /** npm package name (e.g., "droid-valadrien-os-adapter") or local path */
  packageName: string;
...
export function adapterRoutes() {
  ...
  // without modifying ValadrienOs's source code.
  //
