...
interface IncomingMessageWithTerminalContext extends IncomingMessage {
  valadrienOsWebSocketHandled?: boolean;
  valadrienOsTerminalUpgradeContext?: TerminalUpgradeContext;
}
...
export function setupEnvironmentCustomImageTerminalWebSocketServer(
  ...
  wss.on("connection", (socket: TerminalWsSocket, req: IncomingMessage) => {
    const upgradeContext = (req as IncomingMessageWithTerminalContext).valadrienOsTerminalUpgradeContext;
    if (!upgradeContext) {
  ...
  server.on("upgrade", (req, socket, head) => {
    ...
    reqWithContext.valadrienOsWebSocketHandled = true;
    ...
    reqWithContext.valadrienOsTerminalUpgradeContext = {
