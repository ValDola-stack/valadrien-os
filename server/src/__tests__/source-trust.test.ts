...
import { agents, companies, createDb, heartbeatRuns, issues } from "@valadrien-os/db";
import { LOW_TRUST_REVIEW_PRESET } from "@valadrien-os/shared";
import {
...
describeEmbeddedPostgres("resolveActorSourceTrustForIssue", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("valadrien-os-source-trust-");
