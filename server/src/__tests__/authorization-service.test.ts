...
import { LOW_TRUST_REVIEW_PRESET, type PermissionKey } from "@valadrien-os/shared";
import {
...
describeEmbeddedPostgres("authorization service", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("valadrien-os-authorization-service-");
