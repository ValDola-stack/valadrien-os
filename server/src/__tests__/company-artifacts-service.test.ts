...
describeEmbeddedPostgres("companyArtifactsService", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("valadrien-os-company-artifacts-");
  ...
  async function seedArtifacts() {
    ...
    await db.insert(companies).values([
      { id: companyId, name: "ValadrienOs", issuePrefix: "PAP", requireBoardApprovalForNewAgents: false },
