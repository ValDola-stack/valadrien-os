...
import type { CatalogSkill } from "@valadrien-os/shared";
...
describe("skills catalog service", () => {
  ...
  beforeEach(() => {
    ...
    mockRequireResolve.mockImplementation((specifier: string) => {
      if (specifier === "@valadrien-os/skills-catalog/package.json") {
        return "/published/node_modules/@valadrien-os/skills-catalog/package.json";
      }
      if (specifier === "@valadrien-os/skills-catalog/catalog.json") {
        return "/published/node_modules/@valadrien-os/skills-catalog/generated/catalog.json";
      }
  ...
  it("resolves the manifest and bundled skill files from the published package layout", async () => {
    ...
    expect(mockReadFileSync).toHaveBeenCalledWith(
      "/published/node_modules/@valadrien-os/skills-catalog/generated/catalog.json",
      "utf8",
    );
    expect(mockReadFile).toHaveBeenCalledWith(
      "/published/node_modules/@valadrien-os/skills-catalog/catalog/bundled/software-development/published-skill/SKILL.md",
    );
    expect(mockRequireResolve).toHaveBeenCalledWith("@valadrien-os/skills-catalog/package.json");
    expect(mockRequireResolve).toHaveBeenCalledWith("@valadrien-os/skills-catalog/catalog.json");
  });
