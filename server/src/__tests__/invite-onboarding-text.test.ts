...
describe("buildInviteOnboardingTextDocument", () => {
  it("renders a plain-text onboarding doc with expected endpoint references", () => {
    ...
    expect(text).toContain("agentDefaultsPayload.valadrienOsApiUrl");
    expect(text).toContain("hermes_local");
    expect(text).toContain("Hermes-originated ValadrienOs API usage");
    ...
    expect(text).toContain("Do not rotate or invent a ValadrienOs key manually");
