...
async function createGitRepo() {
  const repoRoot = await mkdtemp(path.join(os.tmpdir(), "valadrien-os-finalize-branch-repo-"));
...
describeEmbeddedPostgres("heartbeat workspace finalization branch guard", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("valadrien-os-finalize-branch-");
