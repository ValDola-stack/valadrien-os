...
import { trackErrorHandlerCrash } from "@valadrien-os/shared/telemetry";
...
function getValadrienOsDb(req: Request): Db | null {
  const locals = req.app?.locals as { valadrienOsDb?: Db; db?: Db } | undefined;
  return locals?.valadrienOsDb ?? locals?.db ?? null;
}
