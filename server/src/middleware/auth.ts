...
import { isUuidLike, normalizeAgentApiKeyScope, type DeploymentMode } from "@valadrien-os/shared";
  ...
  return async (req, _res, next) => {
    ...
    if (!key) {
      ...
      if (normalizedRunIdHeader && normalizedRunIdHeader !== claims.run_id) {
        ...
        next(
          unprocessable("X-ValadrienOs-Run-Id does not match signed agent JWT run_id", {
