...
import type { ExternalObjectCanonicalUrl } from "@valadrien-os/shared";
...
const DEFAULT_GITHUB_TOKEN_SECRET_NAMES = ["GITHUB_TOKEN", "GH_TOKEN", "VALADRIEN_OS_GITHUB_TOKEN"] as const;
    ...
    return {
      ...
      async resolve({ companyId, object }) {
        ...
        const headers: Record<string, string> = {
          ...
          "user-agent": "valadrien-os-external-object-resolver",
