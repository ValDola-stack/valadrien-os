...
import { documentRevisions, documents, issueDocuments, issues } from "@valadrien-os/db";
import { isSystemIssueDocumentKey, issueDocumentKeySchema } from "@valadrien-os/shared";
