...
npm view valadrien-os@canary version
```
...
Use the current release issue's `VALADRIEN_OS_COMPANY_ID`, `VALADRIEN_OS_API_URL`,
`VALADRIEN_OS_API_KEY`, and `VALADRIEN_OS_RUN_ID`. Include `X-ValadrienOs-Run-Id` on
...
POST /api/companies/:companyId/cases
{
  ...
  "summary": "Stable release content package for ValadrienOs vYYYY.MDD.P.",
  "status": "in_progress",
  "fields": {
    "schema_version": 1,
    "version": "vYYYY.MDD.P",
...
{
  "title": "ValadrienOs vYYYY.MDD.P release body",
  "format": "markdown",
  "body": "# ValadrienOs vYYYY.MDD.P\n\nRelease summary and links...",
...
- `blog_post`, key `valadrien-os-release:vYYYY.MDD.P:blog-post`, status
  `in_progress`, body document key `body`
- `tweet_storm`, key `valadrien-os-release:vYYYY.MDD.P:tweet-storm`, status
  `in_progress`, body document key `body`
