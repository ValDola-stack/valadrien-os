...
description: >
  Write the Discord announcement for a stable ValadrienOs release from the release
...
2. Resolve the parent `release` case with key `valadrien-os-release:vYYYY.MDD.P`.
...
POST /api/companies/:companyId/cases
{
  ...
  "summary": "Social announcement thread for ValadrienOs vYYYY.MDD.P.",
  "status": "in_review",
  ...
  "fields": {
    ...
    "links": {
      ...
      "official_account": "https://x.com/valadrien-osing"
    },
    "review": {
...
{
  "title": "ValadrienOs vYYYY.MDD.P tweet storm body",
  "format": "markdown",
